    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: const ColorScheme.light(
          primary: Color(0xFF4A90E2), // Ice Blue
          secondary: Color(0xFF003366), // Deep Blue
        ),
        ...
        textTheme: const TextTheme(
          bodyLarge:
              TextStyle(fontSize: 18, color: Color(0xFF003366)), // Deep Blue
          bodyMedium:
              TextStyle(fontSize: 16, color: Color(0xFF336699)), // Light Blue
        ),
      ),
...
class StudentListPage extends StatelessWidget {
  ...
  static const List<Student> students = [
    ...
    Student(
        name: "นายจารุวิทย์ แสงแก้วสิริกุล", id: "653450086-7", gender: "male"),
    Student(name: "นายชวกร เนืองภา", id: "653450087-5", gender: "male"),
    Student(name: "นายณัฐดนัย ภาคภูมิ", id: "653450088-3", gender: "male"),
    Student(
        name: "นางสาวณัฐวรรณ พวงมะลัย", id: "653450089-1", gender: "female"),
    Student(
        name: "นายถิรวัฒน์ โชติธนกิจไพศาล", id: "653450090-6", gender: "male"),
    Student(
        name: "นายเทพฤทธิ์ อินทรประพันธ์", id: "653450091-4", gender: "male"),
    ...
    Student(
        name: "นายพิริยกร พันธุ์พานิชย์", id: "653450098-0", gender: "male"),
    ...
    Student(
        name: "นางสาวศานต์ฤทัย สายบุตร", id: "653450104-1", gender: "female"),
    ...
    Student(
        name: "นางสาวอรปรียา จันทะโคตร", id: "653450107-5", gender: "female"),
    Student(name: "นายอัครวิชญ์ พบวงษา", id: "653450108-3", gender: "male"),
    Student(
        name: "นายกฤตชวกร ชวลิตกิตติวงศ์", id: "653450279-6", gender: "male"),
    ...
    Student(
        name: "นายณัฏฐกิตติ์ มิตรสูงเนิน", id: "653450283-5", gender: "male"),
    ...
    Student(
        name: "นางสาวธนพร รัตนศิระประภา", id: "653450286-9", gender: "female"),
    ...
    Student(
        name: "นางสาวศิริพร แก้วลินลา", id: "653450513-4", gender: "female"),
